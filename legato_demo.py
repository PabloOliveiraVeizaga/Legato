...
st.write("A popularidade da faixa. O valor estará entre 0 e 100, sendo 100 o mais popular. A popularidade de uma faixa é um valor entre 0 e 100, sendo 100 o mais popular. A popularidade é calculada por algoritmo e se baseia, em grande parte, no número total de reproduções da faixa e em quão recentes essas reproduções foram. De modo geral, músicas que estão sendo muito tocadas agora terão uma popularidade maior do que músicas que foram muito tocadas no passado. Faixas duplicadas (por exemplo, a mesma faixa de um single e de um álbum) são classificadas de forma independente. A popularidade do artista e do álbum é derivada matematicamente da popularidade da faixa. Observação: o valor da popularidade pode ter um atraso de alguns dias em relação à popularidade real: o valor não é atualizado em tempo real.")
